...
/**
 * Display similar resources based on main metadata of the current resource.
 *
...
class SeeAlso implements ResourcePageBlockLayoutInterface
{
    ...
    {
        return 'See also (similar resources)'; // @translate
    }
    ...
    public function render(PhpRenderer $view, AbstractResourceEntityRepresentation $resource): string
    {
        ...
        try {
            ...
            $services->get('Omeka\Logger')->err(
                'SeeAlso block: Error searching for similar resources: {message}', // @translate
